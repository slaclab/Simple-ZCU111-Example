...
.. admonition:: Reference toolchain
   ...
   - **Firmware version:** ``v3.0.0.0`` (``PRJ_VERSION = 0x03000000``)
   - **Target FPGA part:** ``xczu28dr-ffvg1517-2-e``
   - **Conda env:** ``rogue_v6.6.1``
...
1. Power down the ZCU111 board.
2. Confirm ``Mode SW6 [4:1] = 1110`` (switch OFF = 1 = High; ON = 0 = Low) to
   select SD boot mode.
