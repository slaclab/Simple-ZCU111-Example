...
.. list-table::
   ...
   * - Index constant
     ...
     - Notes
   * - ``HW_INDEX_C = 0``
     - ``Hardware`` (``AxiSocUltraPlusCore`` + I2C)
     - Platform core (DMA engine, AXI-Lite bridge to PS, LMK/LMX I2C).
   * - ``RFDC_INDEX_C = 1``
     - ``RfDataConverter``
...
* ADC bus: ``dspAdc : Slv256Array(7 downto 0)`` — 8 channels.
* DAC bus: ``dspDac : Slv256Array(7 downto 0)`` — 8 channels.
